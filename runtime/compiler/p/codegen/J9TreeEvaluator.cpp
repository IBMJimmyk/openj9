...
static TR::Register *inlineIntrinsicIndexOf_P10(TR::Node *node, TR::CodeGenerator *cg, bool isLatin1)
   ...
   generateLabelInstruction(cg, TR::InstOpCode::label, node, startLabel);
//--------------------------------------------------------------------------------------
   if (nullptr != TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck", comp->signature()))
      {
      TR::LabelSymbol *afterLenCheckLabel = generateLabelSymbol(cg);

      TR::LabelSymbol *found00Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found01Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found02Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found03Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found04Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found05Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found06Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found07Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found08Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found09Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found10Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found11Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found12Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found13Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found14Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found15Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found16Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found17Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found18Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found19Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found20Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found21Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found22Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found23Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found24Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found25Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found26Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found27Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found28Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found29Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found30Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found31Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found32Label = generateLabelSymbol(cg);

      TR::LabelSymbol *found48Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found64Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found80Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found96Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found112Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found128Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found144Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found160Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found176Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found192Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found208Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found224Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found240Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found256Label = generateLabelSymbol(cg);

      TR::LabelSymbol *found512Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found768Label = generateLabelSymbol(cg);
      TR::LabelSymbol *found1024Label = generateLabelSymbol(cg);

      generateTrg1Src2Instruction(cg, TR::InstOpCode::subf, node, temp, offset, length);

      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 0);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found00Label, cr6); //ble used here
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 1);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found01Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 2);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found02Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 3);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found03Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 4);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found04Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 5);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found05Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 6);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found06Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 7);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found07Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 8);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found08Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 9);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found09Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 10);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found10Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 11);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found11Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 12);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found12Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 13);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found13Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 14);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found14Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 15);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found15Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 16);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found16Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 17);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found17Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 18);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found18Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 19);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found19Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 20);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found20Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 21);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found21Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 22);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found22Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 23);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found23Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 24);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found24Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 25);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found25Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 26);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found26Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 27);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found27Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 28);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found28Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 29);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found29Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 30);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found30Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 31);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found31Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 32);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found32Label, cr6);

      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 48);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found48Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 64);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found64Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 80);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found80Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 96);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found96Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 112);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found112Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 128);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found128Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 144);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found144Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 160);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found160Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 176);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found176Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 192);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found192Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 208);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found208Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 224);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found224Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 240);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found240Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 256);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found256Label, cr6);

      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 512);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found512Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 768);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found768Label, cr6);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr6, temp, 1024);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found1024Label, cr6);

      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/9999/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);


      generateLabelInstruction(cg, TR::InstOpCode::label, node, found00Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/00/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found01Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/01/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found02Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/02/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found03Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/03/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found04Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/04/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found05Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/05/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found06Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/06/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found07Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/07/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found08Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/08/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found09Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/09/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found10Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/10/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found11Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/11/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found12Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/12/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found13Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/13/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found14Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/14/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found15Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/15/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found16Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/16/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found17Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/17/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found18Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/18/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found19Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/19/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found20Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/20/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found21Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/21/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found22Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/22/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found23Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/23/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found24Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/24/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found25Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/25/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found26Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/26/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found27Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/27/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found28Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/28/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found29Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/29/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found30Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/30/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found31Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/31/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found32Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/32/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);

      generateLabelInstruction(cg, TR::InstOpCode::label, node, found48Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/48/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found64Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/64/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found80Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/80/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found96Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/96/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found112Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/112/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found128Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/128/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found144Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/144/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found160Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/160/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found176Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/176/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found192Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/192/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found208Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/208/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found224Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/224/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found240Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/240/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found256Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/256/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);

      generateLabelInstruction(cg, TR::InstOpCode::label, node, found512Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/512/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found768Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/768/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found1024Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfChar/lenCheck/1024/(%s)", comp->signature()));
      //generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);

      generateLabelInstruction(cg, TR::InstOpCode::label, node, afterLenCheckLabel);
      }
//--------------------------------------------------------------------------------------
...
static TR::Register *inlineIntrinsicIndexOfString(TR::Node *node, TR::CodeGenerator *cg, bool isLatin1)
   ...
   generateLabelInstruction(cg, TR::InstOpCode::label, node, startLabel);
//--------------------------------------------------------------------------------------
   if (nullptr != TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck", comp->signature()))
      {
      TR::LabelSymbol *afterLenCheckLabel = generateLabelSymbol(cg);
      ...
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::addi, node, tempReg, fromIndexReg, 0);

      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 0);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found00Label, cr0Reg); //ble used here
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 1);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found01Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 2);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found02Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 3);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found03Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 4);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found04Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 5);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found05Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 6);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found06Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 7);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found07Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 8);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found08Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 9);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found09Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 10);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found10Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 11);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found11Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 12);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found12Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 13);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found13Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 14);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found14Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 15);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found15Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 16);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found16Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 17);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found17Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 18);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found18Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 19);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found19Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 20);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found20Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 21);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found21Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 22);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found22Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 23);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found23Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 24);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found24Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 25);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found25Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 26);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found26Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 27);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found27Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 28);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found28Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 29);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found29Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 30);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found30Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 31);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found31Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 32);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found32Label, cr0Reg);

      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 48);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found48Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 64);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found64Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 80);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found80Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 96);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found96Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 112);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found112Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 128);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found128Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 144);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found144Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 160);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found160Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 176);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found176Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 192);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found192Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 208);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found208Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 224);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found224Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 240);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found240Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 256);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found256Label, cr0Reg);

      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 512);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found512Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 768);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found768Label, cr0Reg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, cr0Reg, tempReg, 1024);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::ble, node, found1024Label, cr0Reg);

      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/9999/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);

      generateLabelInstruction(cg, TR::InstOpCode::label, node, found00Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0000/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found01Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0001/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found02Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0002/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found03Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0003/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found04Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0004/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found05Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0005/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found06Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0006/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found07Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0007/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found08Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0008/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found09Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0009/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found10Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0010/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found11Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0011/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found12Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0012/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found13Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0013/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found14Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0014/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found15Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0015/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found16Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0016/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found17Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0017/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found18Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0018/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found19Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0019/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found20Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0020/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found21Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0021/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found22Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0022/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found23Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0023/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found24Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0024/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found25Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0025/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found26Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0026/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found27Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0027/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found28Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0028/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found29Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0029/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found30Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0030/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found31Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0031/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found32Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0032/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);

      generateLabelInstruction(cg, TR::InstOpCode::label, node, found48Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0048/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found64Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0064/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found80Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0080/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found96Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0096/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found112Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0112/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found128Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0128/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found144Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0144/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found160Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0160/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found176Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0176/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found192Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0192/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found208Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0208/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found224Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0224/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found240Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0240/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found256Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0256/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found512Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0512/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found768Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/0768/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found1024Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringOffset/lenCheck/1024/(%s)", comp->signature()));
      //generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);

      generateLabelInstruction(cg, TR::InstOpCode::label, node, afterLenCheckLabel);
      }

   if (nullptr != TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck", comp->signature()))
      {
      TR::LabelSymbol *afterLenCheckLabel = generateLabelSymbol(cg);
      ...
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::addi, node, tempReg, strCountReg, 0);
      ...
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/9999/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);

      generateLabelInstruction(cg, TR::InstOpCode::label, node, found00Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0000/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found01Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0001/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found02Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0002/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found03Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0003/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found04Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0004/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found05Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0005/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found06Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0006/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found07Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0007/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found08Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0008/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found09Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0009/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found10Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0010/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found11Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0011/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found12Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0012/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found13Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0013/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found14Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0014/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found15Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0015/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found16Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0016/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found17Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0017/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found18Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0018/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found19Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0019/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found20Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0020/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found21Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0021/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found22Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0022/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found23Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0023/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found24Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0024/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found25Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0025/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found26Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0026/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found27Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0027/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found28Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0028/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found29Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0029/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found30Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0030/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found31Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0031/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found32Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0032/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);

      generateLabelInstruction(cg, TR::InstOpCode::label, node, found48Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0048/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found64Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0064/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found80Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0080/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found96Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0096/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found112Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0112/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found128Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0128/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found144Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0144/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found160Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0160/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found176Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0176/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found192Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0192/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found208Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0208/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found224Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0224/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found240Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0240/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found256Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0256/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found512Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0512/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found768Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/0768/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found1024Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfStringSubString/lenCheck/1024/(%s)", comp->signature()));
      //generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);

      generateLabelInstruction(cg, TR::InstOpCode::label, node, afterLenCheckLabel);
      }

   if (nullptr != TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck", comp->signature()))
      {
      TR::LabelSymbol *afterLenCheckLabel = generateLabelSymbol(cg);
      ...
      generateTrg1Src2Instruction(cg, TR::InstOpCode::subf, node, tempReg, strCountReg, arrayLenReg);
      generateTrg1Src2Instruction(cg, TR::InstOpCode::subf, node, tempReg, fromIndexReg, tempReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::addi, node, tempReg, tempReg, 1);
      ...
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/9999/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);


      generateLabelInstruction(cg, TR::InstOpCode::label, node, found00Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/00/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found01Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/01/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found02Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/02/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found03Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/03/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found04Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/04/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found05Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/05/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found06Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/06/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found07Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/07/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found08Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/08/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found09Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/09/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found10Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/10/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found11Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/11/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found12Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/12/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found13Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/13/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found14Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/14/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found15Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/15/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found16Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/16/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found17Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/17/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found18Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/18/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found19Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/19/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found20Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/20/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found21Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/21/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found22Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/22/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found23Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/23/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found24Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/24/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found25Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/25/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found26Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/26/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found27Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/27/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found28Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/28/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found29Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/29/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found30Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/30/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found31Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/31/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found32Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/32/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);

      generateLabelInstruction(cg, TR::InstOpCode::label, node, found48Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/48/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found64Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/64/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found80Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/80/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found96Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/96/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found112Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/112/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found128Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/128/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found144Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/144/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found160Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/160/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found176Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/176/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found192Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/192/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found208Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/208/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found224Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/224/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found240Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/240/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found256Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/256/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);

      generateLabelInstruction(cg, TR::InstOpCode::label, node, found512Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/512/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found768Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/768/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found1024Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicIndexOfString/lenCheck/1024/(%s)", comp->signature()));
      //generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
...
//--------------------------------------------------------------------
   ...
   if (nullptr != TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck", comp->signature()))
      {
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 0);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found00Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 1);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found01Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 2);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found02Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 3);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found03Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 4);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found04Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 5);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found05Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 6);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found06Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 7);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found07Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 8);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found08Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 9);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found09Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 10);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found10Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 11);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found11Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 12);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found12Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 13);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found13Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 14);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found14Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 15);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found15Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 16);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found16Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 17);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found17Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 18);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found18Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 19);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found19Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 20);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found20Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 21);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found21Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 22);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found22Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 23);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found23Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 24);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found24Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 25);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found25Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 26);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found26Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 27);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found27Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 28);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found28Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 29);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found29Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 30);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found30Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 31);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found31Label, condReg);
      generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::cmpi4, node, condReg, remainingReg, 32);
      generateConditionalBranchInstruction(cg, TR::InstOpCode::beq, node, found32Label, condReg);

      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/99/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);



      generateLabelInstruction(cg, TR::InstOpCode::label, node, found00Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/00/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found01Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/01/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found02Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/02/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found03Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/03/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found04Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/04/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found05Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/05/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found06Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/06/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found07Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/07/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found08Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/08/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found09Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/09/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found10Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/10/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found11Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/11/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found12Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/12/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found13Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/13/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found14Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/14/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found15Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/15/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found16Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/16/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found17Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/17/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found18Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/18/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found19Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/19/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found20Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/20/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found21Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/21/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found22Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/22/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found23Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/23/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found24Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/24/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found25Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/25/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found26Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/26/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found27Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/27/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found28Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/28/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found29Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/29/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found30Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/30/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found31Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/31/(%s)", comp->signature()));
      generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
      generateLabelInstruction(cg, TR::InstOpCode::label, node, found32Label);
      cg->generateDebugCounter(TR::DebugCounter::debugCounterName(comp, "inlineIntrinsicInflate/lenCheck/32/(%s)", comp->signature()));
      //generateLabelInstruction(cg, TR::InstOpCode::b, node, afterLenCheckLabel);
...
J9::Power::CodeGenerator::inlineDirectCall(TR::Node *node, TR::Register *&resultReg)
   ...
   if (comp->getSymRefTab()->isNonHelper(node->getSymbolReference(), TR::SymbolReferenceTable::singlePrecisionSQRTSymbol))
      ...
      case TR::java_lang_Thread_onSpinWait:
         ...
         if (!disableOSW)
            {
            logprintf(comp->getOption(TR_TraceCG), comp->log(), "Inlining Thread.onSpinWait call node %p as yield instruction.\n", node);
      ...
      case TR::sun_misc_Unsafe_compareAndSwapLong_jlObjectJJJ_Z:
         logprintf(comp->getOption(TR_TraceCG), comp->log(), "In evaluator for compareAndSwapLong. node = %p node->isSafeForCGToFastPathUnsafeCall = %p\n",
